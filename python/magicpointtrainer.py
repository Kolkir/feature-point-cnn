...
from python.basetrainer import BaseTrainer
from python.netutils import get_points
from python.synthetic_dataset import SyntheticDataset
from python.saveutils import load_checkpoint, save_checkpoint
...
class MagicPointTrainer(BaseTrainer):
    ...
    def train(self, model):
        ...
        class_weight = np.ones(65)
        class_weight[64] = 0.01
